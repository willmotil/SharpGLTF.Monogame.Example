...
namespace WillDxSharpGltf
{
    ...
    public class Game_HdrGpuSideTest : Game
    {
        ...
        public static Effect hdrIblEffect;
        ...
        protected override void LoadContent()
        {
            ...
            hdrIblEffect = Content.Load<Effect>("HdrIBLEffectTest");
        ...
        // move it out of the way, this stuff isn't going to change much for this test.
        //__________________________________________________________________________________________________________________________________________
        // .
        // .
        // .
